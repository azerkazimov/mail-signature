      ...
      <div className="container">
          ...
          <div className="row flex-align-center delete_head">
            ...
            <div>
              <Link className="row delete_dashboard">
                ...
                <p className="font-size-18 font-weight-700 text-primary ">Dashboard</p>
              </Link>
            </div>
          </div>
          ...
          <div>
            <Link to={""} className="row delete_help ">
              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0.6" y="0.6" width="21.8383" height="22.84" rx="10.9192" stroke="#1A73E8" strokeWidth="1.2" />
                <path
              ...
              <p className="font-size-18 font-weight-700 text-primary ">Help Center</p>
            </Link>
          </div>
        </div>
        ...
        <div className="delete_wrap">
          <div className="del_hero">
            <h2 className="font-size-24 font-weight-500 text-text10 ">Delete Account</h2>
            ...
            <p className="font-size-16 font-weight-400 text-inky box ">
              <span className="text-text30 ">By checking the box below, I acknowledge and approve that </span>
              my QR Codes and all scan statistics 
              <span className="text-text30 "> will be deleted, </span>dynamic QR Codes will be deactivated, 
              <span className="text-text30 ">and </span>
               my account user information will be removed.
            </p>
            <div className="row flex-align-center checkbox">
              <input type="checkbox" />
              <p className="font-size-16 font-weight-400 text-text60 pl-2">I want to delete my account</p>
            </div>
            ...
            <textarea
              className="border-text30 font-size-14 font-weight-400 "
              id="w3review"
              name="w3review"
              rows="7"
              cols="80"
            ...
            <div className="mt-7  row flex-justify-end">
              ...
              <button className=" close bg-secondary font-size-18 font-weight-700 text-natural ">
                Close my account
              </button>
            </div>
          </div>
...
export default MyAccountDeleteAccount;
